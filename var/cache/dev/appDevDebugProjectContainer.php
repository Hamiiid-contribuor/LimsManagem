...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Utilisateur\UtilisateurBundle\Form\ProfileType A Utilisateur\UtilisateurBundle\Form\ProfileType instance
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \Utilisateur\UtilisateurBundle\Form\ProfileType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Utilisateur\UtilisateurBundle\Form\RegistrationType A Utilisateur\UtilisateurBundle\Form\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Utilisateur\UtilisateurBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CFvd99g2l3', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KWroebeZGB', 0, 'bQl0wXvrxMCobLJywVUImg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+MAUNamRRp', 0, 'bQl0wXvrxMCobLJywVUImg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Bcz15ExopK', 0, 'bQl0wXvrxMCobLJywVUImg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'LIMS', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Analyses\\AnalysesBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Analyses\\AnalysesBundle\\Entity');
        $c->addDriver($b, 'Utilisateur\\UtilisateurBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AnalysesBundle' => 'Analyses\\AnalysesBundle\\Entity', 'UtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_efd128bb931efdc069537b870924cbb593cccafc04e66f4ac0ec8b1f91755670');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('fssmisilims@gmail.com' => 'LIMS FSSM ISI THEAM'), 'resetting' => array('fssmisilims@gmail.com' => 'LIMS FSSM ISI THEAM'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'Utilisateur\\UtilisateurBundle\\Form\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Utilisateur\\UtilisateurBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'Utilisateur\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['swiftmailer.mailer.default.transport.real'] = new \Swift_Transport_SendmailTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Analyses\\AnalysesBundle/Resources/views'), 'Analyses');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AnalysesBundle' => 'Analyses\\AnalysesBundle\\AnalysesBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'fssmisilims@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'fssmisilimsidrissi06',
            ...
            'fos_user.profile.form.type' => 'Utilisateur\\UtilisateurBundle\\Form\\ProfileType',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'fssmisilims@gmail.com' => 'LIMS FSSM ISI THEAM',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'Utilisateur\\UtilisateurBundle\\Form\\RegistrationType',
