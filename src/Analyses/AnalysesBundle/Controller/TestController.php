...
use Analyses\AnalysesBundle\Entity\Test;
...
class TestController extends Controller {
    ...
    public function newAction(Request $request) {
        $test = new Test();
        $form = $this->createForm('Analyses\AnalysesBundle\Form\TestType', $test);
    ...
    public function editAction(Request $request, Test $test) {
        $deleteForm = $this->createDeleteForm($test);
        $editForm = $this->createForm('Analyses\AnalysesBundle\Form\TestType', $test);
