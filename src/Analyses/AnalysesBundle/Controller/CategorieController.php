...
use Analyses\AnalysesBundle\Entity\Categorie;
...
class CategorieController extends Controller {
    ...
    public function newAction(Request $request) {
        ...
        $form = $this->createForm('Analyses\AnalysesBundle\Form\CategorieType', $categorie);
    ...
    public function editAction(Request $request, Categorie $categorie) {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('Analyses\AnalysesBundle\Form\CategorieType', $categorie);
